...
@Database(
    entities = arrayOf(
        ...
        Budget::class,
        PayLoad::class
    ),views =[Vw_category_spent::class], version = 9)
...
/*            INSTANCE?.customDao()
        ...
        private fun getBudgetList(): List<Budget> {
            ...
            budgetList.add(Budget(1,1000,Util.getCurrentMonth(),Util.getCurrentYear()))
            budgetList.add(Budget(2,2000,Util.getCurrentMonth(),Util.getCurrentYear()))
            budgetList.add(Budget(3,3000,Util.getCurrentMonth(),Util.getCurrentYear()))
            budgetList.add(Budget(4,25000,Util.getCurrentMonth(),Util.getCurrentYear()))
            budgetList.add(Budget(1,500,Util.getCurrentMonth()-1,Util.getCurrentYear()))
            return budgetList
        }
        ...
        private fun getPurchaseList(): List<PurchaseItem> {
           ...
           // addBulkAmount(purchaseList)
            ...
            purchaseList.add(PurchaseItem(5,1,120))
            purchaseList.add(PurchaseItem(5,2,200))
            return purchaseList
        }

        private fun addBulkAmount(purchaseList: java.util.ArrayList<PurchaseItem>) {
            purchaseList.add(PurchaseItem(1,1,12))
            purchaseList.add(PurchaseItem(1,2,20))
            purchaseList.add(PurchaseItem(1,1,12))
            purchaseList.add(PurchaseItem(1,2,20))
        ...
        private fun getShoppingList(): List<Shopping> {
            ...
            shoppingList.add(Shopping(5,Util.getCurrentMili()))
            return shoppingList
        }

        private fun getDefaultCustomDate(): List<CustomDate> {
            var customDateList=ArrayList<CustomDate>()
            customDateList.add(CustomDate(Util.getCurrentYear(),Util.getCurrentMonth(),1))
            customDateList.add(CustomDate(Util.getCurrentYear(),Util.getCurrentMonth(),2))
            customDateList.add(CustomDate(Util.getCurrentYear(),Util.getCurrentMonth(),2))
            customDateList.add(CustomDate(Util.getCurrentYear(),Util.getCurrentMonth(),4))
            customDateList.add(CustomDate(Util.getCurrentYear(),Util.getCurrentMonth()-1,4))
