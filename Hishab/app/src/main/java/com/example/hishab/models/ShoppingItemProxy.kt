...
data class ShoppingItemProxy(public var proxyId:Long, public val category: Category, public val product: Product, public val purchaseItem: PurchaseItem):Serializable, BaseObservable() {
