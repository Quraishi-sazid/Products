...
class GenericAdapterForTwoViewTypes<T1, T2, B1 : ViewDataBinding, B2 : ViewDataBinding> private constructor(
    ...
    var checkIfFirstViewTypePredicate: Predicate<Int>? = null
    ...
    companion object {
        fun <T1,T2, B1 : ViewDataBinding,B2 : ViewDataBinding> Create(layoutId1: Int,layoutId2: Int, diffUtil: DiffUtil.ItemCallback<Any>?=null)
            ...
            return GenericAdapterForTwoViewTypes<T1,T2, B1,B2>(layoutId1,layoutId2, passingDiffUtil)
        }
    }
}