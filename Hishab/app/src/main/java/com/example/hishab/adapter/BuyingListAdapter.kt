...
class BuyingListAdapter(
    ...
    inner class ViewHolder(val binding: LayoutBuyingItemBinding):RecyclerView.ViewHolder(binding.root) {
        fun bind(buyingHistory: BuyingHistory)
        {
            ...
            binding.rvBuyingListItem.setOnClickListener(View.OnClickListener {
                navigationCallBack.navigate(buyingHistoryList[adapterPosition].getBuyingId())
            })
