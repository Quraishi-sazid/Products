...
data class BuyingItemProxy(public var proxyId:Long, public val category: Category, public val shoppingItem: ShoppingItem, public val purchaseItem: PurchaseItem):Serializable, BaseObservable() {
