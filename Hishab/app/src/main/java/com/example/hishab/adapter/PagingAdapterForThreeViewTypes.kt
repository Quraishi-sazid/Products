...
class PagingAdapterForThreeViewTypes<T1, T2, T3, B1 : ViewDataBinding, B2 : ViewDataBinding, B3 : ViewDataBinding> private constructor(
    ...
    companion object {
        fun <T1, T2, T3, B1 : ViewDataBinding, B2 : ViewDataBinding, B3 : ViewDataBinding> Create(
            ...
            return PagingAdapterForThreeViewTypes<T1, T2, T3, B1, B2, B3>(
