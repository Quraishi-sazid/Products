...
class BottomNavigationTitleTabLayoutFragmentsMapping() {
    private val titleTabLayoutFragmentsMapping: HashMap<Int, List<ViewPagerFragmentProxy>> =
        HashMap<Int, List<ViewPagerFragmentProxy>>()

    init {
        var historyFragmentsList = ArrayList<ViewPagerFragmentProxy>()
        historyFragmentsList.add(
            ViewPagerFragmentProxy(
                ShoppingHistoryFragment(),
                "Shopping History"
            )
        );
        historyFragmentsList.add(
            ViewPagerFragmentProxy(
                ...
                "Purchase History Flat"
            )
        );
        historyFragmentsList.add(
            ViewPagerFragmentProxy(
                (CategoryCostFragment()),
                "Category Details"
            )
        );
        ...
        budgetFragmentList.add(
            ViewPagerFragmentProxy(
                BudgetAndSpentFragment(),
                "Category and Budget"
            )
        )
        budgetFragmentList.add(
            ViewPagerFragmentProxy(
                BudgetAndSpentHistoryFragment(),
                "Budget History"
            )
        )
        ...
        categoryProductFragmentList.add(
            ViewPagerFragmentProxy(
        ...
        categoryProductFragmentList.add(
            ViewPagerFragmentProxy(
                ProductCategoryMappingFragment(),
    ...
    fun getViewPagerFragmentAtPosition(
    ...
    fun getFragmentCountFromBottomnavigationId(selectedBottomNavigationId: Int): Int {
        return titleTabLayoutFragmentsMapping[selectedBottomNavigationId]!!.size
    }
}