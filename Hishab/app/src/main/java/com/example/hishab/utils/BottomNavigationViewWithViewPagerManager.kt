...
class BottomNavigationViewWithViewPagerManager private constructor(
    ...
    companion object {
        ...
        ): BottomNavigationViewWithViewPagerManager {
            if (instance == null) {
                instance =
                    BottomNavigationViewWithViewPagerManager(navHostFragment, bottomNavigationView)
            }
            return instance!!
        }
    }
